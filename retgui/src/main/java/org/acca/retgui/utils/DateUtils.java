...
//    }
    ...
    /**
     * <pre>
     * Increase random milliseconds after the date of calculation date .    
     * 
     *  DateUtils.addMilliSecond(1970-01-01 10:00:00) = 1970-01-01 10:00:01 345
     * </pre>
     * 
     * @param date Date
     * @return Date
     */
    public static Date addRandomMilliSecond(Date date){
        if(date == null){
            return null;
        }
        ...
        c.add(Calendar.MILLISECOND, Math.abs(random.nextInt()%1000));
        return c.getTime();
    }
