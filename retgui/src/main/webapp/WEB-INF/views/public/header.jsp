			...
			<ul class="nav navbar-nav pull-right">
				...
				<li class="dropdown dropdown-extended dropdown-notification"
					...
					data-hover="dropdown" data-close-others="true"> <i
						class="fa fa-warning"></i> <span class="badge badge-default">
							7 </span>
				</a>
					...
					<ul class="dropdown-menu">
						...
						<li>
							<ul class="dropdown-menu-list scroller" style="height: 250px;">
								...
								<li><a href="inbox.html?a=view"> <span class="photo">
											<img src="<c:url value="/assets/admin/layout/img/avatar3.jpg"/>" alt="" />
								...
								<li><a href="inbox.html?a=view"> <span class="photo">
											<img sr<c:url value="/assets/admin/layout/img/avatar1.jpg"/>" alt="" />
								...
								<li><a href="inbox.html?a=view"> <span class="photo">
											<img sr<c:url value="/assets/admin/layout/img/avatar2.jpg"/>" alt="" />
									</span> <span class="subject"> <span class="from"> Lisa
								...
								<li><a href="inbox.html?a=view"> <span class="photo">
											<img sr<c:url value="/assets/admin/layout/img/avatar3.jpg"/>" alt="" />
									</span> <span class="subject"> <span class="from">
