...
<spring:url var="commonSearchUrl" value="/${model}s/datatable"></spring:url>
<spring:url var="commonCreateUrl" value="/${model}/new"></spring:url>
<spring:url var="commonEditUrl" value="/${model}"></spring:url>
<spring:url var="commonDeleteUrl" value="/${model}"></spring:url>
...
<div id="${tablename}_delete-modal" class="modal fade"
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">确定删除这条记录吗？</div>
			<div class="modal-footer">
				<button class="btn green" type="button"
					id="${tablename}_delete-modal-confirm">确定</button>
				<button class="btn default" data-dismiss="modal" type="button">取消</button>
			</div>
		</div>
	</div>
</div>
